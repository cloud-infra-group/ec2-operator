...
func init() {
	...
	utilruntime.Must(ec2operatorcloudinfragroupiov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4adf9906.cloud-infra-group.io",
	...
	if err = (&controller.AWSVPCEndpointServiceReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "AWSVPCEndpointService")
		os.Exit(1)
	}
	if err = (&controller.AWSVPCEndpointServicePrincipalReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
