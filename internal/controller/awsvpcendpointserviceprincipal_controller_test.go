...
var _ = Describe("AWSVPCEndpointServicePrincipal Controller", func() {
	Context("When reconciling a resource", func() {
		...
		awsvpcendpointserviceprincipal := &ec2operatorcloudinfragroupiov1alpha1.AWSVPCEndpointServicePrincipal{}
		...
		BeforeEach(func() {
			...
			if err != nil && errors.IsNotFound(err) {
				resource := &ec2operatorcloudinfragroupiov1alpha1.AWSVPCEndpointServicePrincipal{
		...
		It("should successfully reconcile the resource", func() {
			...
			controllerReconciler := &AWSVPCEndpointServicePrincipalReconciler{
				Client: k8sClient,
